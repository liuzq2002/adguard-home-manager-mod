        ...
        lineBarsData: List<LineChartBarData>.from(
            data["lines"].map((item) => LineChartBarData(
                  ...
                  belowBarData: BarAreaData(
                      show: true, color: item['color'].withOpacity(0.2)),
                ))),
          ...
          touchTooltipData: LineTouchTooltipData(
              ...
              getTooltipItems: (items) {
                return [
                  ...
                  ...items.sublist(0, items.length - 1).asMap().entries.map(
    ...
    Map<String, dynamic> formatData(CombinedChartData unformattedData) {
      ...
      List<FlSpot> dataLine(List<int> data) {
        ...
        for (int i = 0; i < data.length; i++) {
          ...
          formattedData.add(FlSpot(xPosition.toDouble(), data[i].toDouble()));
          xPosition++;
        }
      ...
      List<FlSpot> datesLine(int number) {
        ...
        for (int i = 0; i < number; i++) {
          formattedData.add(FlSpot(i.toDouble(), 0));
        }
      ...
      return {'lines': toDraw, 'topPoint': topPoint};
    }
