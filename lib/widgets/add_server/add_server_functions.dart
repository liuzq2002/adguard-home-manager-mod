...
String? validatePort({required String? value, required BuildContext context}) {
  if (value != null && value != '') {
...
String? validateAddress(
  ...
  if (value != null && value != '') {
    if (Regexps.ipv4Address.hasMatch(value) == true ||
        Regexps.ipv6Address.hasMatch(value) == true ||
        Regexps.domain.hasMatch(value) == true) {
      return null;
    } else {
...
void openServerFormModal({
  ...
  showGeneralDialog(
    context: context,
    barrierColor: width <= 700 ? Colors.transparent : Colors.black54,
