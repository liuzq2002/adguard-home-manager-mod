...
class ShowHideTopItemsList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    void updateValue(HomeTopItems value, bool newStatus) {
      if (newStatus == true) {
        setEnabledHomeTopItems([...enabledHomeTopItems, value]);
      } else {
        setEnabledHomeTopItems(
            enabledHomeTopItems.where((e) => e != value).toList());
      }
    }
            ...
            slivers: [
              ...
              SliverList.list(children: [
                ...
                CustomSwitchListTile(
                  value:
                      enabledHomeTopItems.contains(HomeTopItems.queriedDomains),
                ...
                CustomSwitchListTile(
                  value:
                      enabledHomeTopItems.contains(HomeTopItems.blockedDomains),
                ...
                CustomSwitchListTile(
                  value:
                      enabledHomeTopItems.contains(HomeTopItems.topUpstreams),
                ...
                CustomSwitchListTile(
                  value: enabledHomeTopItems
                      .contains(HomeTopItems.avgUpstreamResponseTime),
                  onChanged: (v) =>
                      updateValue(HomeTopItems.avgUpstreamResponseTime, v),
                  title:
                      AppLocalizations.of(context)!.averageUpstreamResponseTime,
