...
class DnsServerSettingsScreen extends StatefulWidget {
  ...
  @override
  State<DnsServerSettingsScreen> createState() =>
      _DnsServerSettingsScreenState();
}
...
class _DnsServerSettingsScreenState extends State<DnsServerSettingsScreen> {
  ...
  bool validateData() {
    if ((_limitRequestsController.text == "" ||
            (_limitRequestsController.text != "" &&
                _limitRequestsError == null)) &&
        _ednsIpError == null &&
        _ttlController.text != "" &&
        _ttlError == null &&
        (_ipv4PrefixSubnetController.text == "" ||
            (_ipv4PrefixSubnetController.text != "" &&
                _ipv4PrefixSubnetError == null)) &&
        (_ipv6PrefixSubnetController.text == "" ||
            (_ipv6PrefixSubnetController.text != "" &&
                _ipv6PrefixSubnetError == null))) {
      return true;
    } else {
      return false;
    }
  ...
  void initState() {
    ...
    if (dnsProvider.dnsInfo!.ednsCsEnabled == true)
      _expandableCustomEdns.toggle();
    if (dnsProvider.dnsInfo!.ednsCsUseCustom == true)
    ...
    _ttlController.text = dnsProvider.dnsInfo!.blockedResponseTtl != null
        ...
        : "";
    _ipv4PrefixSubnetController.text =
        dnsProvider.dnsInfo!.ratelimitSubnetLenIpv4 != null
            ? dnsProvider.dnsInfo!.ratelimitSubnetLenIpv4.toString()
            : "";
    _ipv6PrefixSubnetController.text =
        dnsProvider.dnsInfo!.ratelimitSubnetLenIpv6 != null
  ...
  Widget build(BuildContext context) {
    ...
    void saveData() async {
      ...
      final result = await dnsProvider.saveDnsServerConfig({
        ...
        "ratelimit_subnet_len_ipv4":
            int.tryParse(_ipv4PrefixSubnetController.text),
        "ratelimit_subnet_len_ipv6":
            int.tryParse(_ipv6PrefixSubnetController.text),
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: dataValid == true ? () => saveData() : null,
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.only(
                  left: 16, right: 16, bottom: 24, top: 4),
              child: TextFormField(
                controller: _limitRequestsController,
                onChanged: (v) =>
                    setState(() => _limitRequestsError = validateNumber(v)),
                decoration: InputDecoration(
                    prefixIcon: const Icon(Icons.looks_one_rounded),
                    border: const OutlineInputBorder(
                        borderRadius: BorderRadius.all(Radius.circular(10))),
                    labelText:
                        AppLocalizations.of(context)!.limitRequestsSecond,
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                onChanged: (v) =>
                    setState(() => _ipv4PrefixSubnetError = validateNumber(v)),
                decoration: InputDecoration(
                    prefixIcon: const Icon(Icons.skip_previous_rounded),
                    border: const OutlineInputBorder(
                        borderRadius: BorderRadius.all(Radius.circular(10))),
                    labelText:
                        AppLocalizations.of(context)!.subnetPrefixLengthIpv4,
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                onChanged: (v) =>
                    setState(() => _ipv6PrefixSubnetError = validateNumber(v)),
                decoration: InputDecoration(
                    prefixIcon: const Icon(Icons.skip_previous_rounded),
                    border: const OutlineInputBorder(
                        borderRadius: BorderRadius.all(Radius.circular(10))),
                    labelText:
                        AppLocalizations.of(context)!.subnetPrefixLengthIpv6,
            ...
            CustomListTile(
              ...
              subtitle:
                  AppLocalizations.of(context)!.rateLimitAllowlistDescription,
              onTap: () => showDialog(
                context: context,
                builder: (context) => RateLimitAllowlistModal(
                    values: _rateLimitAllowlist,
                    onConfirm: (ips) =>
                        setState(() => _rateLimitAllowlist = ips)),
              ),
              trailing: _rateLimitAllowlist.isNotEmpty
                  ? Container(
            ...
            CustomSwitchListTile(
              ...
              onChanged: (value) => setState(() {
                ...
                if (value == false) {
                  ...
                  if (_expandableEdnsIp.expanded == true)
                    _expandableEdnsIp.toggle();
                ...
                child: Expandable(
                  ...
                  expanded: Column(
                    children: [
                      CustomSwitchListTile(
                        padding: const EdgeInsets.only(
                            left: 50, top: 12, bottom: 12, right: 16),
                      ...
                      ExpandableNotifier(
                          ...
                          child: Expandable(
                            ...
                            expanded: Padding(
                              padding: const EdgeInsets.only(
                                  top: 16, bottom: 16, right: 16, left: 70),
                              child: TextFormField(
            ...
            CustomSwitchListTile(
              ...
              onChanged: (value) =>
                  setState(() => _disableIpv6Resolving = value),
              title: AppLocalizations.of(context)!.disableResolvingIpv6,
              subtitle:
                  AppLocalizations.of(context)!.disableResolvingIpv6Description,
            ),
