...
class FilterStatusModal extends StatefulWidget {
  ...
  const FilterStatusModal(
      {super.key, required this.value, required this.dialog});
                      ...
                      children: [
                        ...
                        _ItemsList(
                          selectedResultStatus:
                              logsProvider.selectedResultStatus,
                          updateSelectedResultStatus: (v) =>
                              logsProvider.setSelectedResultStatus(value: v),
                        ),
                        Container(height: 16)
                      ],
                    ),
