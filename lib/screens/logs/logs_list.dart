...
class _LogsListWidgetState extends State<LogsListWidget> {
  ...
  bool scrollListener(ScrollUpdateNotification scrollNotification) {
    ...
    if (scrollNotification.metrics.extentAfter < 500 &&
        logsProvider.isLoadingMore == false) {
                            ...
                            child: NotificationListener(
                              ...
                              child: CustomScrollView(
                                slivers: [
                                  ...
                                  if (logsProvider.logsData!.data.isNotEmpty)
                                    SliverList.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          ...
                                          } else if (logsProvider.logsData!
                                                  .data[index].question.name !=
                                              null) {
                                            return LogTile(
                                              log: logsProvider
                                                  .logsData!.data[index],
                                              ...
                                              length: logsProvider
                                                  .logsData!.data.length,
                                              isLogSelected:
                                                  widget.selectedLog != null &&
                                                      widget.selectedLog ==
                                                          logsProvider.logsData!
                                                              .data[index],
                                              onLogTap: (log) {
                                  ...
                                  if (logsProvider.logsData!.data.isEmpty)
                                    SliverFillRemaining(
                                      child: Center(
                                        child: Column(
